...
function getSelect(options) {
  const only = process.env.npm_config_select != undefined
      ...
      if (getSelect(options) == 'phpfpm' || getSelect(options) == undefined) {
        ...
        versions.forEach((version) => {
          ...
          if (selectfolder == undefined || selectfolder == version ||
            ...
            cmdbuild.push(`cp images/phpfpm/${
                version}/Dockerfile build/phpfpm/${versionimage}/Dockerfile`);
            cmdbuild.push(`sed -i 's/VERSIONIMAGE/php:${
                versionimage}-fpm/' build/phpfpm/${versionimage}/Dockerfile`);
            cmdbuild.push(`docker build -t koromerzhin/php:${
                versionimage}-fpm build/phpfpm/${
                versionimage} --target build-phpfpm`);
            cmdbuild.push(`docker build -t koromerzhin/php:${
                versionimage}-fpm-wordpress build/phpfpm/${
                versionimage} --target build-phpfpm-wordpress`);
            cmdbuild.push(`docker build -t koromerzhin/php:${
                versionimage}-fpm-symfony build/phpfpm/${
                versionimage} --target build-phpfpm-symfony`);
            if (getXdebug(options) == 'on') {
              cmdbuild.push(`docker build -t koromerzhin/php:${
                  versionimage}-fpm-xdebug build/phpfpm/${
                  versionimage} --target build-phpfpm-xdebug`);
              cmdbuild.push(`docker build -t koromerzhin/php:${
                  versionimage}-fpm-wordpress-xdebug build/phpfpm/${
                  versionimage} --target build-phpfpm-wordpress-xdebug`);
              cmdbuild.push(`docker build -t koromerzhin/php:${
                  versionimage}-fpm-symfony-xdebug build/phpfpm/${
                  versionimage} --target build-phpfpm-symfony-xdebug`);
            }
            if (getLatest(options) == 'on') {
              cmdtag.push(`docker image tag koromerzhin/php:${
                  versionimage}-fpm koromerzhin/php:fpm-latest`);
              cmdtag.push(`docker image tag koromerzhin/php:${
                  versionimage}-fpm-wordpress koromerzhin/php:fpm-wordpress-latest`);
              cmdtag.push(`docker image tag koromerzhin/php:${
                  versionimage}-fpm-symfony koromerzhin/php:fpm-symfony-latest`);
              if (getXdebug(options) == 'on') {
                cmdtag.push(`docker image tag koromerzhin/php:${
                    versionimage}-fpm-wordpress-xdebug koromerzhin/php:fpm-latest-wordpress-xdebug`);
                cmdtag.push(`docker image tag koromerzhin/php:${
                    versionimage}-fpm-symfony-xdebug koromerzhin/php:fpm-latest-symfony-xdebug`);
                cmdtag.push(`docker image tag koromerzhin/php:${
      ...
      if (getSelect(options) == 'apache' || getSelect(options) == undefined) {
        ...
        versions.forEach((version) => {
          ...
          if (selectfolder == undefined || selectfolder == version ||
            ...
            cmdbuild.push(
                `cp images/php-apache/${version}/Dockerfile build/php-apache/${
            ...
            cmdbuild.push(`docker build -t koromerzhin/php:${
                versionimage}-apache-wordpress build/php-apache/${
                versionimage} --target build-php-apache-wordpress`);
            cmdbuild.push(`docker build -t koromerzhin/php:${
                versionimage}-apache-symfony build/php-apache/${
                versionimage} --target build-php-apache-symfony`);
            if (getXdebug(options) == 'on') {
              cmdbuild.push(`docker build -t koromerzhin/php:${
                  versionimage}-apache-xdebug build/php-apache/${
                  versionimage} --target build-php-apache-xdebug`);
              cmdbuild.push(`docker build -t koromerzhin/php:${
                  versionimage}-apache-wordpress-xdebug build/php-apache/${
                  versionimage} --target build-php-apache-wordpress-xdebug`);
              cmdbuild.push(`docker build -t koromerzhin/php:${
                  versionimage}-apache-symfony-xdebug build/php-apache/${
                  versionimage} --target build-php-apache-symfony-xdebug`);
            }
            if (getLatest(options) == 'on') {
              cmdtag.push(`docker image tag koromerzhin/php:${
                  versionimage}-apache koromerzhin/php:apache-latest`);
              cmdtag.push(`docker image tag koromerzhin/php:${
                  versionimage}-apache-wordpress koromerzhin/php:apache-wordpress-latest`);
              cmdtag.push(`docker image tag koromerzhin/php:${
                  versionimage}-apache-symfony koromerzhin/php:apache-symfony-latest`);
              if (getXdebug(options) == 'on') {
                cmdtag.push(`docker image tag koromerzhin/php:${
                    versionimage}-apache-xdebug koromerzhin/php:apache-latest-xdebug`);
                cmdtag.push(`docker image tag koromerzhin/php:${
                    versionimage}-apache-wordpress-xdebug koromerzhin/php:apache-wordpress-latest-xdebug`);
                cmdtag.push(`docker image tag koromerzhin/php:${
                    versionimage}-apache-symfony-xdebug koromerzhin/php:apache-symfony-latest-xdebug`);
              }
            }
          }
        });
